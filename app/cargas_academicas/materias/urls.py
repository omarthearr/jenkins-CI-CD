...
urlpatterns = [
    ...
    path('lista-programas', views.ProgramasListView.as_view(),
         name='lista_programas'),
    path('lista-programas-filter', views.lista_programas_filter,
         name='lista_programas_filter'),

    path('nuevo-programa', views.ProgramaCreateView.as_view(), name='nuevo_programa'),
    path('editar-programa/<int:pk>',
         views.ProgramaUpdateView.as_view(), name='editar_programa'),
    path('eliminar-programa/<int:pk>',
         views.ProgramaDeleteView.as_view(), name='eliminar_programa'),
